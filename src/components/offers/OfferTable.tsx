...
interface OfferTableProps {
  ...
  onToggleStatus?: (offerId: string, newStatus: string) => void;
...
export default function OfferTable({ 
  ...
  const handleToggleStatus = (offerId: string, currentStatus: string, e: React.MouseEvent) => {
    e.stopPropagation(); // Prevent row click event from firing
    if (onToggleStatus) {
      const newStatus = currentStatus === 'active' ? 'inactive' : 'active';
      onToggleStatus(offerId, newStatus);
    }
  };
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="dropdown-trigger">
                          ...
                          {isAdvertiser && onToggleStatus && (
                            <DropdownMenuItem onClick={(e) => handleToggleStatus(offer.id, offer.status || 'active', e)}>
                              {offer.status === 'active' ? (
                                <>
